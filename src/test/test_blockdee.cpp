...
#define BOOST_TEST_MODULE BlockDee Test Suite

#include "test_blockdee.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_blockdee_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
