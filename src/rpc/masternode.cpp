...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner BlockDee address\n"
            "  payee          - Print the masternode payout BlockDee address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting BlockDee address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "blockdee",               "masternode",             &masternode,             true,  {} },
    { "blockdee",               "masternodelist",         &masternodelist,         true,  {} },
    { "blockdee",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "blockdee",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
