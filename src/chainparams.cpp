...
// Copyright (c) 2021 The BlockDee Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1613845211, nBits=1e0ffff0, nNonce=295551, vtx=1)
...
{
    const char* pszTimestamp = "Adolfo is my bestfriend this is shehzad words";
    const CScript genesisOutputScript = CScript() << ParseHex("042d30f3605838ed5bb9bee55aee2b5b6381f1e9eba009adfd44387f797a754603d8b5784bbbe3a28cce064c9629d9b85db855a71eb113f218cac6dde785ee0602") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000001adbae4c7845f9b4336e9b8bc4057c8dfb6b5f2ac78d544dc29e79e7003"); 
        ...
        vAlertPubKey = ParseHex("04cae96b1d4cb7df1272a4c65edf7af658da655bf8941817f15d6ef8cb8d60ef6adf8af9400d826ee8919c503421513aee1994dabbdff20ea5a024770b4cf7090f");
        nDefaultPort = 29964;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1613845211, 295551, 0x1e0ffff0, 1, 20 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000001adbae4c7845f9b4336e9b8bc4057c8dfb6b5f2ac78d544dc29e79e7003"));
        assert(genesis.hashMerkleRoot == uint256S("0xa3b815a8ac8a5c5e06f6a1455b420955c3229dc2773c5a8b56512b1cdba4d404"));
        ...
        // BlockDee BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // BlockDee BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // BlockDee BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"BNF6zJZy4ZGQceChTev7tspmCmw9CmKeGR"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x000001adbae4c7845f9b4336e9b8bc4057c8dfb6b5f2ac78d544dc29e79e7003"))
        };

        chainTxData = ChainTxData{
            1613845211, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000001472e72e128a970671014488484462abfbc48f0dca4662dfde3f29510f7"); 

        pchMessageStart[0] = 0xb0;
        pchMessageStart[1] = 0x42;
        pchMessageStart[2] = 0xeb;
        pchMessageStart[3] = 0x19;
        vAlertPubKey = ParseHex("04a992e311890422524280df9b7056944d21ac41ece5ffa4c9a0775d4ca16a2aaca647b0555cc958c515ffddc95530920f406892eaad4c969115daea74566e136d");
        nDefaultPort = 39964;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1613845216UL, 288204UL, 0x1e0ffff0, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000001472e72e128a970671014488484462abfbc48f0dca4662dfde3f29510f7"));
        assert(genesis.hashMerkleRoot == uint256S("0xa3b815a8ac8a5c5e06f6a1455b420955c3229dc2773c5a8b56512b1cdba4d404"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,153);
        // Testnet BlockDee BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet BlockDee BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet BlockDee BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"BR3S9hroijj4HdvDTcgdahX6tiLH7CC1xf"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000001472e72e128a970671014488484462abfbc48f0dca4662dfde3f29510f7"))
        };

        chainTxData = ChainTxData{
            1613845216, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1613845221, 1, 0x207fffff, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1d3c305c1ad40d566892df0a3108b2d560c6490b84f8b94cd0eadb9b3ef2fb94"));
        assert(genesis.hashMerkleRoot == uint256S("0xa3b815a8ac8a5c5e06f6a1455b420955c3229dc2773c5a8b56512b1cdba4d404"));

        devnetGenesis = FindDevNetGenesisBlock(consensus, genesis, 20 * COIN);
        consensus.hashDevnetGenesisBlock = devnetGenesis.GetHash();

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("blockdeeevo.org",  "devnet-seed.blockdeeevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x1d3c305c1ad40d566892df0a3108b2d560c6490b84f8b94cd0eadb9b3ef2fb94"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 69z4zZN4Lrp4E5WmJGLffGZwYxuUnWrM8WKvfCLstLjtJrvh3EZ
        vSporkAddresses = {"BTeiTT2Py2LMDhiU7pCNskxqvxzy1QSfmi"};
        nMinSporkKeys = 1;
        ...
        // Regtest BlockDee addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        // Regtest BlockDee script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,26);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,153);
        // Regtest BlockDee BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest BlockDee BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest BlockDee BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
