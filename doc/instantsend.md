...
This mechanism has been integrated into Bitcore-Node-BlockDee which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/blockdeepay/insight-api-blockdee#web-socket-api](https://github.com/blockdeepay/insight-api-blockdee#web-socket-api)
* API: [https://github.com/blockdeepay/insight-api-blockdee#instantsend-transactions](https://github.com/blockdeepay/insight-api-blockdee#instantsend-transactions)
