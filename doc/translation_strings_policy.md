...
This document provides guidelines for internationalization of the BlockDee Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blockdee_en.ts` remains unchanged.
