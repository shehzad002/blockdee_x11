...
Arguments:
    <base_directory> - The base directory of a BlockDee Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BlockDee Core developers'
...
Arguments:
    <base_directory> - The base directory of BlockDee Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BlockDee Core repository.
"""
