...
from test_framework.test_framework import BlockDeeTestFramework
...
class LLMQCoinbaseCommitmentsTest(BlockDeeTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BlockDeeTestFramework doesn't support this atm)
